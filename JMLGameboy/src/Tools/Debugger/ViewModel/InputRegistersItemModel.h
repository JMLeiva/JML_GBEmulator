...
#ifndef JML_D_INPUTREGISTERSITEMMODEL
#define JML_D_INPUTREGISTERSITEMMODEL

#include <QtWidgets\QtWidgets>
#include "../../../Core/Memory/MemoryController.h"

class InputRegistersItemModel : public QStandardItemModel
{
public:
	InputRegistersItemModel(MemoryController* memoryController);// , QObject * parent);
	void Refresh();
...
#endif // !JML_D_INPUTREGISTERSITEMMODEL
