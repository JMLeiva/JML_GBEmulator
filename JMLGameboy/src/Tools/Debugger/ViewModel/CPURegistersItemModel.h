...
#ifndef JML_D_CPUREGISTERSITEMMODEL
#define JML_D_CPUREGISTERSITEMMODEL

#include <QtWidgets\QtWidgets>
#include "../../../Core/CPU/CPU.h"

class CPURegistersItemModel : public QStandardItemModel
{
public:
	CPURegistersItemModel(CPU* cpu);// , QObject * parent);
	void Refresh();
...
#endif // !JML_D_CPUREGISTERSITEMMODEL
