...
#ifndef JML_D_DEBUGGERTOOLS
#define JML_D_DEBUGGERTOOLS

#include <QtCore\qstring.h>

extern QString getRegFormattedQString(unsigned short val, int zeros, int base);
extern QString getRegFormattedQString(unsigned short val, int zeros, int base, const char* prefix);

#endif // !JML_D_DEBUGGERTOOLS
